 ...
 *      - 단순 경로(Simple Path): 처음 노드과 끝 노드를 제외하고 중복된 노드가 없는 경로
 ...
 * 
 * 3. 그래프와 트리의 차이
 *  - 트리는 그래프에 속한 특별한 종류라고 볼 수 있음
 *  - 그래프
 *      - 정의 : 노드와 노드를 연결하는 간선으로 표현되는 자료 구조
 *      - 방향성 : 방향 그래프, 무방향 그래프 둘 다 존재함
