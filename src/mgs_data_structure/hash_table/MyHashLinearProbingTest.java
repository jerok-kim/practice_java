...
public class MyHashLinearProbingTest {
    public static void main(String[] args) {
        ...
        MyHashLinearProbing.Slot[] hashTable = new MyHashLinearProbing.Slot[20];
        hashTable[0] = new MyHashLinearProbing.Slot("test-key", "test-value");
